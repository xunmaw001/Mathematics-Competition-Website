...
public class ExamredetailsEntity<T> implements Serializable {
     ...
     * 审核结果
     */
    @TableField(value = "examredetails_types")

    private Integer examredetailsTypes;
	 ...
	 * 设置：审核结果
	 */
    public Integer getExamredetailsTypes() {
        return examredetailsTypes;
    }
    ...
    public void setExamredetailsTypes(Integer examredetailsTypes) {
        this.examredetailsTypes = examredetailsTypes;
    }
    /**
	 * 设置：创建时间
	 */
    ...
    public String toString() {
        return "Examredetails{" +
            ...
            ", examredetailsTypes=" + examredetailsTypes +

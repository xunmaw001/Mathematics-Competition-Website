    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='examquestion'">
                    <el-form-item class="select" v-if="type!='info'"  label="试题表" prop="examquestionId">
                        <el-select v-model="ruleForm.examquestionId" :disabled="ro.examquestionId" filterable placeholder="请选择试题表" @change="examquestionChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试题名称" prop="examquestionName">
                        <el-input v-model="examquestionForm.examquestionName"
                                  placeholder="试题名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion' ">
                    <el-form-item class="input" v-if="type!='info'"  label="选项" prop="examquestionOptions">
                        <el-input v-model="examquestionForm.examquestionOptions"
                                  placeholder="选项" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="选项" prop="examquestionOptions">
                            <el-input v-model="ruleForm.examquestionOptions"
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion' ">
                    <el-form-item class="input" v-if="type!='info'"  label="分值" prop="examquestionScore">
                        <el-input v-model="examquestionForm.examquestionScore"
                                  placeholder="分值" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试题类型" prop="examquestionValue">
                        <el-input v-model="examquestionForm.examquestionValue"
                                  placeholder="试题类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试题排序，值越大排越前面" prop="examquestionSequence">
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="试题排序，值越大排越前面" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="试题排序，值越大排越前面" prop="examquestionSequence">
            ...
            <input id="examquestionId" name="examquestionId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="审核教师" prop="examinationName">
                       <el-input v-model="ruleForm.examinationName"
                                 placeholder="审核教师" clearable  :readonly="ro.examinationName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="审核教师" prop="examinationName">
                           <el-input v-model="ruleForm.examinationName"
                                     placeholder="审核教师" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="审核结果" prop="examredetailsTypes">
                        <el-select v-model="ruleForm.examredetailsTypes" :disabled="ro.examredetailsTypes" placeholder="请选择审核结果">
                            <el-option
                                v-for="(item,index) in examredetailsTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="审核结果" prop="examredetailsValue">
                        <el-input v-model="ruleForm.examredetailsValue"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   examinationName: [
                              { required: true, message: '审核教师不能为空', trigger: 'blur' },
                          ],
                   examredetailsTypes: [

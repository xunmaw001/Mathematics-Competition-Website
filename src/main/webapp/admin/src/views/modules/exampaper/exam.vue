<template>
    <div class="container">
        <div class="top-content">
            ...
            <div class="right-content">
                <el-button v-if="!isEndFlag" type="danger" round @click="leaveTap">结束考试</el-button>
            </div>
        </div>
        ...
        >{{answer==this.ruleForm.examquestionAnswer?'正确':'错误'}}</span>
            ...
            <div class="item-content" style="color:#888888">
                <el-button @click="submitTap" type="primary">下一题</el-button>
            </div>
        </div>
        <div class="detail-content" v-if="isEndFlag">
            <div class="item-content">
        <span class="label">
          考试成绩：
                ...
                <span class="content">请耐心等待教师批改</span>
            </div>
            <div class="item-content" style="color:#888888">
        ...
        mounted() {
            ...
            this.$http({
                ...
                if (data && data.code === 0) {
                    ...
                    if(this.ruleForm.examquestionTypes !=4){

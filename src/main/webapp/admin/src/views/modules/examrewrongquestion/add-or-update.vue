            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='exampaper'">
                    <el-form-item class="select" v-if="type!='info'"  label="试卷表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" :disabled="ro.exampaperId" filterable placeholder="请选择试卷表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试卷名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="试卷名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' ">
                    <el-form-item class="input" v-if="type!='info'"  label="考试时长(分钟)" prop="exampaperDate">
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="考试时长(分钟)" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试卷总分" prop="exampaperMyscore">
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="试卷总分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="试卷总分" prop="exampaperMyscore">
                            <el-input v-model="ruleForm.exampaperMyscore"
                                      placeholder="试卷总分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='exampaper' ">
                    <el-form-item class="input" v-if="type!='info'"  label="试卷状态" prop="exampaperValue">
                        <el-input v-model="exampaperForm.exampaperValue"
                                  placeholder="试卷状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
